...
<body>
		<div class="container">
		<center><h1 class="subheader-title">EDIT CUSTOMER</h1></center>
		<div class="customer-box">
	  		<form:form action="/bizwiz/customers/${oneCustomerView.id}/edit" method="post" modelAttribute="oneCustomerView" class="row g-3">
				...
				<c:if test="${oneCustomerView.user.id==loggedInUser.id}">
				<form:form action="/bizwiz/customers/${oneCustomerView.id}/delete" method="post">
					<input type="hidden" name="_method" value="delete">
					<input type="submit" class='btn outline-dark btn-lg' value="DELETE">
				</form:form>
		    	</c:if>
 		</div>
  	</div>
